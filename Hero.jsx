  ...
  return (
    ...
    >
      ...
      <div className='relative z-20 flex flex-col items-center justify-center h-full text-center text-white px-4'>
        ...
        <h1 className='text-4xl font-bold mb-6'>ATITHI HOTELS</h1>

        <button className='bg-lime-500 text-black font-bold py-3 px-6 rounded-lg hover:bg-lime-600 transition'>
          BOOK YOUR STAY
        </button>
      </div>
    </div>
